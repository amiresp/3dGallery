...
export const createCeiling = (scene, textureLoader) => {
  // Load the textures
  const colorTexture = textureLoader.load("OfficeCeiling005_4K-JPG/Color.jpg");
  const displacementTexture = textureLoader.load(
    "OfficeCeiling005_4K-JPG/Displacement.jpg"
  );
  const aoTexture = textureLoader.load(
    "OfficeCeiling005_4K-JPG/AmbientOcclusion.jpg"
  );
  const emissionTexture = textureLoader.load(
    "OfficeCeiling005_4K-JPG/normal.jpg"
  );
  const metalnessTexture = textureLoader.load(
    "OfficeCeiling005_4K-JPG/reflection.jpg"
  );
  const normalGLTexture = textureLoader.load(
    "OfficeCeiling005_4K-JPG/normlmapping.tif"
  );
  const roughnessTexture = textureLoader.load(
    "OfficeCeiling005_4K-JPG/glossiness.jpg"
  );
